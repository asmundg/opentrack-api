...
def start_lists(
    ...
    events: Annotated[
        Optional[list[str]],
        typer.Option("--event", "-e", help="Event type code(s) to process"),
    ] = None,
    ...
    try:
        ...
        create_start_lists(
            data, output_filename=output, events=events_to_process, day=day
        )
...
def competitors_by_club(
    ...
    format: Annotated[
        str, typer.Option("--format", "-f", help="Output format: csv, pdf, or both")
    ] = "csv",
) -> None:
