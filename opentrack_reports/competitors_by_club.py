...
def save_competitors_to_csv(data: list[dict[str, Any]], filename: str = 'competitors_by_club.csv') -> None:
...
def print_usage() -> None:
    ...
    print("Usage: python3 competitors_by_club.py <url_or_file> [options] [output_base_filename]")
    print("\nArguments:")
    print("  url_or_file             URL to OpenTrack competition or local JSON file path")
    ...
    print("  python3 competitors_by_club.py https://data.opentrack.run/x/2023/NOR/ntm/ --both custom_output")
