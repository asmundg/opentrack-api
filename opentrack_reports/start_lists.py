...
def create_start_lists(data: dict[str, Any], output_filename: Optional[str] = None, event_type: Optional[str] = None, events: Optional[list[str]] = None, day: Optional[int] = None) -> None:
    """
